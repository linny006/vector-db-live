...
| 22 | [vanedb/vanedb](https://github.com/vanedb/vanedb) | 0 | Rust | 2026-09-15 | Embeddable vector database for edge AI |
| 23 | [Mehdi138534/ai-news-scraper](https://github.com/Mehdi138534/ai-news-scraper) | 0 | HTML | 2026-09-15 | 📰 Scrape and analyze AI news articles efficiently while powering semantic search capabilities for better insights and un |
| 24 | [zubairporag/yu-ai-agent](https://github.com/zubairporag/yu-ai-agent) | 0 | Java | 2026-09-15 | 🤖 Develop cutting-edge AI applications with the "yu-ai-agent" project, enhancing your skills and boosting your job prosp |
| 25 | [ermermermermidk/mcp-ai-memory](https://github.com/ermermermermidk/mcp-ai-memory) | 1 | TypeScript | 2026-09-15 | 🧠 Manage AI context seamlessly with the MCP server for storing and retrieving semantic memory across sessions. Enhance y |
| 26 | [nguyenquoaca-hash/agentic-mesh](https://github.com/nguyenquoaca-hash/agentic-mesh) | 2 | HTML | 2026-09-15 | Multi-Agent AI Orchestrator 2026 🚀 \| YAML, 6+ LLM Providers, ReAct & Swarm |
| 27 | [Vigneshkumar-29/simple-rag-document-qa](https://github.com/Vigneshkumar-29/simple-rag-document-qa) | 0 | Python | 2026-09-15 | Simple RAG Document QA is a lightweight Retrieval-Augmented Generation (RAG) project that answers user questions using i |
| 28 | [RediSearch/RediSearch](https://github.com/RediSearch/RediSearch) | 6238 | Rust | 2026-09-15 | A query and indexing engine for Redis, providing secondary indexing, full-text search, vector similarity search and aggr |
...
| 30 | [neomjs/neo-agent-brain](https://github.com/neomjs/neo-agent-brain) | 10 | JavaScript | 2026-09-15 | Point a cross-model AI engineering team at your own codebases. The Agent OS keeps named AI maintainers' identity, memory |
| 31 | [rostamlabs/rostam](https://github.com/rostamlabs/rostam) | 36 | Go | 2026-09-15 | Open-source vector database and sub-microsecond key-value store in one Go engine — embed it as a library, run it standal |
| 32 | [FraiseHQ/fraise](https://github.com/FraiseHQ/fraise) | 7 | Go | 2026-09-15 | In-memory knowledge store for AI agents |
| 33 | [weaviate/weaviate](https://github.com/weaviate/weaviate) | 16815 | Go | 2026-09-15 | Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector  |
| 34 | [zaahist/design-to-ship-playbook](https://github.com/zaahist/design-to-ship-playbook) | 1 | HTML | 2026-09-15 | AI Blueprint Generator 2026: PRDs to Agent Prompts in One Click |
| 35 | [MariaDB/server](https://github.com/MariaDB/server) | 8228 | C++ | 2026-09-15 | MariaDB server is a community developed fork of MySQL server. Started by core members of the original MySQL team, MariaD |
| 36 | [desikai-lab/Marrow](https://github.com/desikai-lab/Marrow) | 6 | Python | 2026-09-15 | Give your AI coding agents memory that survives between sessions. Marrow is an MCP server providing persistent task trac |
| 37 | [makr-code/ThemisDB](https://github.com/makr-code/ThemisDB) | 9 | C++ | 2026-09-15 | Themis Database System - High-performance C++ hybrid-database (graph-vector-relational-file) with AQL support and MVCC.  |
| 38 | [kakagawa/llm-master-ua](https://github.com/kakagawa/llm-master-ua) | 0 | Python | 2026-09-15 | Українська адаптація повного курсу з інженерії великих мовних моделей: RAG, агенти, донавчання, деплой, Transformer і ма |
| 39 | [Benorina1/llm-vector-retrieval-playbook](https://github.com/Benorina1/llm-vector-retrieval-playbook) | 0 | HTML | 2026-09-15 | Master LLM Search in 2026: The Complete Semantic AI Handbook |
| 40 | [DemigodDSK/hubmesh](https://github.com/DemigodDSK/hubmesh) | 2 | Python | 2026-09-15 | Centrality-aware GraphRAG retrieval planner — drop-in layer over any vector DB. Zero LLM in the query path; MCP server i |
| 41 | [paradedb/paradedb](https://github.com/paradedb/paradedb) | 9265 | Rust | 2026-09-15 | One Postgres for your application data, full-text search, vector retrieval, and aggregations. Home of the pg_search exte |
| 42 | [cyborginc/cyborgdb-py](https://github.com/cyborginc/cyborgdb-py) | 8 | Python | 2026-09-15 | Python Client SDK for CyborgDB: The Encrypted Vector Database |
| 43 | [4nur4gmishr4/4nur4gmishr4](https://github.com/4nur4gmishr4/4nur4gmishr4) | 2 | JavaScript | 2026-09-15 | Backend-focused fullstack & applied ai dev. Building cool stuff with LLMs & agents. Obsessed with clean architecture & s |
...
| 46 | [vespa-engine/vespa](https://github.com/vespa-engine/vespa) | 7087 | Java | 2026-09-15 | The AI search platform |
| 47 | [pinecone-io/pinecone-api](https://github.com/pinecone-io/pinecone-api) | 9 | — | 2026-09-15 | Public OpenAPI specs for Pinecone RESTful APIs and Protobuf definitions |
| 48 | [dringel/myAI6](https://github.com/dringel/myAI6) | 1 | TypeScript | 2026-09-15 | Build your own AI assistant: RAG chatbot template with web search, verified citations, conversation compression, and mod |

...
| 20 | [databendlabs/databend](https://github.com/databendlabs/databend) | 9355 | Rust | 2026-06-27 | Data Agent Ready Warehouse : One for  Analytics, Search, AI, Python Sandbox.  — rebuilt from scratch. Unified architectu |
...
| 22 | [jourdaninorder609/mind-query](https://github.com/jourdaninorder609/mind-query) | 0 | TypeScript | 2026-06-27 | Convert natural language into SQL and MQL queries for PostgreSQL, MySQL, SQL Server, and MongoDB using an MCP-enabled ag |
| 23 | [GlitterKill/sdl-mcp](https://github.com/GlitterKill/sdl-mcp) | 400 | TypeScript | 2026-06-27 | Symbol Delta Ledger (SDL-MCP) is a policy-centered context budget layer for coding agents: Symbol-graph intelligence com |
| 24 | [Surging-scotandlot818/product-dev-blueprint](https://github.com/Surging-scotandlot818/product-dev-blueprint) | 0 | TypeScript | 2026-06-27 | Transform software concepts into structured build plans with this schema-first product planning tool for engineering tea |
| 25 | [Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker](https://github.com/Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker) | 0 | Dockerfile | 2026-06-27 | Build a multi-collection RAG system using LlamaIndex and Qdrant in a Docker environment. |
| 26 | [constancywoodsy286/agentic-rag-for-practice](https://github.com/constancywoodsy286/agentic-rag-for-practice) | 1 | Python | 2026-06-27 | Build an agentic RAG document QA system with multi-user support, hybrid retrieval, reranking, and LangGraph workflows fo |
| 27 | [ArcadeData/arcadedb](https://github.com/ArcadeData/arcadedb) | 975 | Java | 2026-06-27 | ArcadeDB Multi-Model Database, one DBMS that supports SQL, Cypher, Gremlin, HTTP/JSON, MongoDB and Redis. ArcadeDB is a  |
| 28 | [jefffergunson118-beep/smara](https://github.com/jefffergunson118-beep/smara) | 1 | — | 2026-06-27 | Sync persistent memory across your AI tools and agents using a unified MCP server. |
| 29 | [Tobiaszn8972/turboquant-gpu](https://github.com/Tobiaszn8972/turboquant-gpu) | 2 | Python | 2026-06-27 | Compress KV cache for LLM inference with 5.02x efficiency on NVIDIA GPUs using cuTile kernels. |
| 30 | [sarcosomebankcheck694/coordinode](https://github.com/sarcosomebankcheck694/coordinode) | 0 | Rust | 2026-06-27 | Unify graph, vector, and full-text search in one Rust engine for GraphRAG and AI retrieval with OpenCypher and MVCC |
| 31 | [Rippledirham767/LongParser](https://github.com/Rippledirham767/LongParser) | 0 | Python | 2026-06-27 | Parse PDFs, DOCX, PPTX, XLSX, and CSV into validated, AI-ready chunks for privacy-first RAG pipelines with HITL review |
| 32 | [viviannenitrogenous100/mentedb](https://github.com/viviannenitrogenous100/mentedb) | 0 | — | 2026-06-27 | Build an AI memory database for agents with a Rust storage engine designed for LLM data and fast retrieval |
| 33 | [cornelablastular720/dbdb-index](https://github.com/cornelablastular720/dbdb-index) | 1 | Go | 2026-06-27 | Browse and index 1,071 database systems from DBDB.io for fast discovery, comparison, and research |
| 34 | [Twentyeight-lawnchair711/AlayaRenderer](https://github.com/Twentyeight-lawnchair711/AlayaRenderer) | 0 | — | 2026-06-27 | Build an AI-native renderer for games and virtual worlds, with data and tools for world creation and editing |
| 35 | [azhkyaw/chunklens](https://github.com/azhkyaw/chunklens) | 0 | Python | 2026-06-27 | The local-first inspector & retrieval debugger for ChromaDB. |
...
| 38 | [Synchronic-leafbud824/skill-vault](https://github.com/Synchronic-leafbud824/skill-vault) | 1 | — | 2026-06-27 | Organize, secure, and find Claude Code skills in one vault for easy reuse |
| 39 | [Genusophiophagussqueezeplay359/ragpipe](https://github.com/Genusophiophagussqueezeplay359/ragpipe) | 0 | Python | 2026-06-27 | Build RAG pipelines in 3 functions for vector databases with zero config and support for Ollama, OpenAI, Qdrant, Pinecon |
| 40 | [aziz5971/TalentLens](https://github.com/aziz5971/TalentLens) | 2 | Python | 2026-06-27 | Analyze candidates with a multi-agent AI screening pipeline that matches skills, verifies background, and prepares inter |
| 41 | [Deafened-vascularstructure846/pageindex-rag](https://github.com/Deafened-vascularstructure846/pageindex-rag) | 1 | Python | 2026-06-27 | Build vectorless RAG for reasoning-based retrieval and answer generation with no embeddings or vector store |
| 42 | [roberthalfway204/Document-Intelligent-Assistant](https://github.com/roberthalfway204/Document-Intelligent-Assistant) | 1 | Python | 2026-06-27 | Transform scanned documents into searchable, structured data with OCR, AI extraction, and Python automation |
| 43 | [lannyfervent952/fastapi-agent-blueprint](https://github.com/lannyfervent952/fastapi-agent-blueprint) | 1 | Python | 2026-06-27 | Build FastAPI AI agents with a clear blueprint for reliable, maintainable app architecture |
| 44 | [Bielrezende/WMB-100K](https://github.com/Bielrezende/WMB-100K) | 0 | — | 2026-06-27 | Benchmark AI memory systems for situational retrieval with 4.3M tokens and 2,708 questions in real-world scenarios |
| 45 | [zaahist/design-to-ship-playbook](https://github.com/zaahist/design-to-ship-playbook) | 0 | HTML | 2026-06-27 | AI Blueprint Generator 2026: PRDs to Agent Prompts in One Click |
...
| 48 | [nicolbl95/Enterprise-Copilot](https://github.com/nicolbl95/Enterprise-Copilot) | 0 | Python | 2026-06-27 | Multi-agent RAG copilot for enterprise documentation using Gradio, FastAPI, LangGraph, Qdrant Cloud, Anthropic Claude, a |

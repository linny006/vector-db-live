...
| 28 | [christopherkarani/Wax](https://github.com/christopherkarani/Wax) | 797 | Swift | 2026-09-18 | Shared Single-file memory layer for all your agents, sub mili-second RAG over text, photo and video on Apple Silicon.. N |
...
| 33 | [elastic/mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch) | 718 | Rust | 2026-09-18 |  |
| 34 | [paradedb/paradedb](https://github.com/paradedb/paradedb) | 9283 | Rust | 2026-09-18 | One Postgres for your application data, full-text search, vector retrieval, and aggregations. Home of the pg_search exte |
| 35 | [KenBoller/Snowball](https://github.com/KenBoller/Snowball) | 1 | Python | 2026-09-18 |  |
| 36 | [jefffergunson118-beep/smara](https://github.com/jefffergunson118-beep/smara) | 1 | — | 2026-09-18 | Sync persistent memory across your AI tools and agents using a unified MCP server. |
| 37 | [prasadsumit/notebridge](https://github.com/prasadsumit/notebridge) | 0 | Java | 2026-09-18 | A tool that helps serious independent learners turn their existing notes into cited, trustworthy practice quizzes—withou |
...
| 40 | [ian-cowley/Glacier.Vector](https://github.com/ian-cowley/Glacier.Vector) | 6 | C# | 2026-09-18 | High-performance, SIMD-accelerated vector search engine and MCP server for .NET 10. Optimized for LLM embeddings and sem |
| 41 | [weaviate/weaviate](https://github.com/weaviate/weaviate) | 16821 | Go | 2026-09-18 | Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector  |
| 42 | [Benorina1/llm-vector-retrieval-playbook](https://github.com/Benorina1/llm-vector-retrieval-playbook) | 0 | HTML | 2026-09-18 | Master LLM Search in 2026: The Complete Semantic AI Handbook |
...
| 44 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 34664 | Rust | 2026-09-18 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
| 45 | [Uncomfortable-filagree112/OpenViking](https://github.com/Uncomfortable-filagree112/OpenViking) | 0 | — | 2026-09-18 | Provide a scalable context database designed to improve memory and data handling for AI agents in complex tasks. |
| 46 | [cornellebivalved856/example-multimodal-rag](https://github.com/cornellebivalved856/example-multimodal-rag) | 0 | Python | 2026-09-18 | Search and retrieve information from text, images, and video using unified Gemini Embedding 2 vectors with Supabase and  |
| 47 | [Boney-massiveness357/ragscope](https://github.com/Boney-massiveness357/ragscope) | 0 | Python | 2026-09-18 | Build a Q&A API that indexes PDFs and text using RAG, logging queries with MLflow for offline document search and evalua |
| 48 | [conceited-watergillyflower311/meilisearch-desktop](https://github.com/conceited-watergillyflower311/meilisearch-desktop) | 1 | TypeScript | 2026-09-18 | Manage Meilisearch instances across platforms with a desktop app built using Tauri 2 and React for efficient, cross-plat |
| 49 | [4nur4gmishr4/4nur4gmishr4](https://github.com/4nur4gmishr4/4nur4gmishr4) | 2 | JavaScript | 2026-09-18 | Backend-focused fullstack & applied ai dev. Building cool stuff with LLMs & agents. Obsessed with clean architecture & s |
| 50 | [23skdu/longbow](https://github.com/23skdu/longbow) | 13 | Go | 2026-09-18 | Apache Arrow Flight clustered vector engine for high throughput Agent memory sharing  |
<!-- TRACKER_TABLE_END -->

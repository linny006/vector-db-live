...
| 11 | [qdrant/qdrant-js](https://github.com/qdrant/qdrant-js) | 458 | TypeScript | 2026-08-04 | JavaScript/Typescript SDK for Qdrant Vector Database |
...
| 16 | [GlitterKill/sdl-mcp](https://github.com/GlitterKill/sdl-mcp) | 461 | TypeScript | 2026-08-04 | Symbol Delta Ledger (SDL-MCP) is a policy-centered context budget layer for coding agents: Symbol-graph intelligence com |
| 17 | [GiulioDER/RE-call](https://github.com/GiulioDER/RE-call) | 2 | Python | 2026-08-04 | RE-call — Retrieval-Augmented Self-Recall: RAG over an AI agent's own memory that knows when it doesn't know (gap detect |
| 18 | [lancedb/lancedb](https://github.com/lancedb/lancedb) | 11074 | Rust | 2026-08-04 | Developer-friendly OSS embedded retrieval library for multimodal AI. Search More; Manage Less. |
| 19 | [sergiunicoara/Generative-AI](https://github.com/sergiunicoara/Generative-AI) | 3 | Python | 2026-08-04 | Production GraphRAG portfolio — knowledge graph platform (Neo4j, hybrid retrieval, GNN reranking, RAGAS-evaluated), RAG  |
| 20 | [Abdullah1dev/ai-pdf-assistant-rag](https://github.com/Abdullah1dev/ai-pdf-assistant-rag) | 1 | Python | 2026-08-04 | RAG pipeline for natural-language Q&A over large PDFs using LangChain, FAISS vector store, and Streamlit. Chunked retrie |
...
| 28 | [matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) | 1874 | Go | 2026-08-04 | AI-native HTAP database with Git-for-Data and built-in vector search, serving as the data and memory backbone for intell |
| 29 | [dkylewillis/vera](https://github.com/dkylewillis/vera) | 16 | Python | 2026-08-04 |  |
| 30 | [vespa-engine/vespa](https://github.com/vespa-engine/vespa) | 7035 | Java | 2026-08-04 | The AI search platform |
...
| 33 | [yantrikos/yantrikdb-server](https://github.com/yantrikos/yantrikdb-server) | 169 | Rust | 2026-08-04 | Cognitive memory database for AI agents — consolidates duplicates, detects contradictions, fades stale memories via temp |
| 34 | [hopepranav08/Clintra](https://github.com/hopepranav08/Clintra) | 3 | Python | 2026-08-04 | AI drug-discovery research assistant — RAG over PubMed, PubChem, PDB & ClinicalTrials.gov with multi-provider LLM routin |
| 35 | [tuned-org-uk/arrowspace-rs](https://github.com/tuned-org-uk/arrowspace-rs) | 40 | Rust | 2026-08-04 | Vectors analytics and search library using dispersion models. Provides graph analysis, vector search and a energy-distri |
| 36 | [Zizka-ai/ZizkaDB](https://github.com/Zizka-ai/ZizkaDB) | 36 | Python | 2026-08-04 | Operational database for AI agents , causal lineage (why()), semantic memory, live dashboards, MCP + Python/TypeScript S |
| 37 | [topoteretes/cognee](https://github.com/topoteretes/cognee) | 29772 | Python | 2026-08-04 | Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions |
| 38 | [verygoodplugins/mcp-automem](https://github.com/verygoodplugins/mcp-automem) | 63 | TypeScript | 2026-08-04 | MCP client for AutoMem — give Claude, Cursor, Codex, and other MCP tools durable graph+vector memory across conversation |
| 39 | [SeekStorm/SeekStorm](https://github.com/SeekStorm/SeekStorm) | 1904 | Rust | 2026-08-04 | SeekStorm: vector & lexical search - in-process library & multi-tenancy server, in Rust. |
| 40 | [SynapseKit/SynapseKit](https://github.com/SynapseKit/SynapseKit) | 21 | Python | 2026-08-04 | Minimal, async-first Python framework for production LLM apps- 2 hard deps, no magic, no SaaS.  |
| 41 | [HarshTomar1234/OncoRAG](https://github.com/HarshTomar1234/OncoRAG) | 0 | Python | 2026-08-04 | Production RAG + agentic oncology knowledge system on Weaviate  , real CIViC/ClinicalTrials.gov/openFDA data, tuned hybr |
...
| 43 | [devyanshyadav/librenote-ai](https://github.com/devyanshyadav/librenote-ai) | 6 | TypeScript | 2026-08-04 | The open-source, self-hosted alternative to NotebookLM. |
| 44 | [RonsenbergVI/fraise](https://github.com/RonsenbergVI/fraise) | 2 | Go | 2026-08-04 | In-memory knowledge store for AI agents |
| 45 | [PYLA-VENKATA-SAI-KARTHIK/Rag_document_assistant](https://github.com/PYLA-VENKATA-SAI-KARTHIK/Rag_document_assistant) | 1 | Python | 2026-08-04 |  |
| 46 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 33777 | Rust | 2026-08-04 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
| 47 | [yantrikos/yantrikdb](https://github.com/yantrikos/yantrikdb) | 47 | Rust | 2026-08-04 | Cognitive memory engine for AI agents — temporal decay, contradiction detection, autonomous consolidation, knowledge gra |
| 48 | [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 6423 | Python | 2026-08-04 |  Memory library for building stateful agents |
| 49 | [bunlongheng/ai-lab](https://github.com/bunlongheng/ai-lab) | 0 | TypeScript | 2026-08-04 | Local-first RAG second brain - key-free embeddings, SQLite vector store, Obsidian ingestion, MCP server for Claude Code |
| 50 | [theblag/llm-api-gateway](https://github.com/theblag/llm-api-gateway) | 0 | Python | 2026-08-04 | A high-performance FastAPI-based LLM API gateway designed to reduce application latency and API consumption costs using  |
<!-- TRACKER_TABLE_END -->

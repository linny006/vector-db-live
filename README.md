...
| 20 | [meilisearch/meilisearch](https://github.com/meilisearch/meilisearch) | 58955 | Rust | 2026-08-13 | A lightning-fast search engine API bringing AI-powered hybrid search to your sites and applications. |
| 21 | [qtuanph/chatbot-rag](https://github.com/qtuanph/chatbot-rag) | 1 | Python | 2026-08-13 | Production-ready Vietnamese RAG platform with LlamaIndex, Qdrant hybrid retrieval, provider management, and real-time an |
| 22 | [vivekkhillar/RAG-APPLICATION](https://github.com/vivekkhillar/RAG-APPLICATION) | 0 | Python | 2026-08-13 | LLM chatbot trained for analysis the Financial Record which PDF will be processed |
| 23 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | 45623 | Go | 2026-08-13 | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search |
| 24 | [neuron-core/neuron-ai](https://github.com/neuron-core/neuron-ai) | 2050 | PHP | 2026-08-13 | The Agentic Framework of the PHP ecosystem to build production-ready AI driven applications. Connect components (LLMs, T |
| 25 | [topoteretes/cognee](https://github.com/topoteretes/cognee) | 29992 | Python | 2026-08-13 | Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions |
...
| 27 | [MariaDB/server](https://github.com/MariaDB/server) | 8090 | C++ | 2026-08-13 | MariaDB server is a community developed fork of MySQL server. Started by core members of the original MySQL team, MariaD |
...
| 29 | [zaahist/design-to-ship-playbook](https://github.com/zaahist/design-to-ship-playbook) | 1 | HTML | 2026-08-13 | AI Blueprint Generator 2026: PRDs to Agent Prompts in One Click |
| 30 | [hanyeol/model-compose](https://github.com/hanyeol/model-compose) | 76 | Python | 2026-08-13 | Deploy production-ready AI services in minutes. One YAML file for agents, RAG pipelines, and MCP servers — run anywhere. |
| 31 | [Artemon-line/ai-memory-hub](https://github.com/Artemon-line/ai-memory-hub) | 2 | Python | 2026-08-13 | Local-first shared memory for AI agents, with MCP and HTTP APIs. |
| 32 | [qdrant/skills](https://github.com/qdrant/skills) | 220 | Python | 2026-08-13 | Agent skills for Qdrant vector search: scaling, performance optimization, search quality, monitoring, deployment, model  |
| 33 | [izynegallardo/vector-embeddings](https://github.com/izynegallardo/vector-embeddings) | 0 | — | 2026-08-13 | Sample of how vector embeddings works using OpenAI API, OpenRouter and Supabase pgvector.  |

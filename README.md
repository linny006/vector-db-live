...
| 18 | [Dakera-AI/dakera-go](https://github.com/Dakera-AI/dakera-go) | 1 | Go | 2026-06-16 | Go SDK for Dakera AI agent memory — self-hosted, 88.2% LoCoMo. Vectors, hybrid search, knowledge graphs, sessions. |
| 19 | [Dakera-AI/dakera-rs](https://github.com/Dakera-AI/dakera-rs) | 6 | Rust | 2026-06-16 | Rust SDK for Dakera AI agent memory — self-hosted, 88.2% LoCoMo. HTTP/gRPC, vectors, hybrid search, knowledge graphs, se |
| 20 | [marinoalfonso/open-pertosa](https://github.com/marinoalfonso/open-pertosa) | 0 | Python | 2026-06-16 | Sistema RAG per la consultazione in linguaggio naturale di documenti amministrativi pubblici. Sviluppato per il Comune d |
| 21 | [pinecone-io/pinecone-ts-client](https://github.com/pinecone-io/pinecone-ts-client) | 272 | TypeScript | 2026-06-16 | The official TypeScript/Node client for the Pinecone vector database |
| 22 | [tanaos/cognitor](https://github.com/tanaos/cognitor) | 11 | Python | 2026-06-16 | Open source, all-in-one semantic search engine for AI and humans |
| 23 | [kaivid-labs/evret](https://github.com/kaivid-labs/evret) | 18 | Python | 2026-06-16 | Evals framework for Information Retrieval Systems |
| 24 | [Dakera-AI/dakera-deploy](https://github.com/Dakera-AI/dakera-deploy) | 11 | JavaScript | 2026-06-16 | Self-hosted Dakera AI memory server — Docker Compose, Kubernetes, Helm, HA cluster setup, and monitoring. |
...
| 27 | [Dakera-AI/dakera-py](https://github.com/Dakera-AI/dakera-py) | 2 | Python | 2026-06-16 | Python SDK for Dakera AI agent memory — self-hosted, 88.2% LoCoMo. Vectors, hybrid search, knowledge graphs, sessions. |
| 28 | [diegoglozano/revector](https://github.com/diegoglozano/revector) | 0 | Rust | 2026-06-16 | Declarative, versioned schema & config migrations for Qdrant — Alembic for vector collections. |
...
| 30 | [goutamroy/ai-life-copilot](https://github.com/goutamroy/ai-life-copilot) | 0 | Python | 2026-06-16 | Production-ready Agentic AI Assistant with RAG, LangGraph workflows, Amazon Bedrock, vector search, and AWS deployment. |
| 31 | [Aaryav1130/rag-chatbot](https://github.com/Aaryav1130/rag-chatbot) | 0 | Python | 2026-06-16 | RAG (Retrieval-augmented generation) ChatBot that provides answers based on contextual information extracted from a coll |
| 32 | [GlitterKill/sdl-mcp](https://github.com/GlitterKill/sdl-mcp) | 368 | TypeScript | 2026-06-16 | Symbol Delta Ledger (SDL-MCP) gives coding agents the right code context, not your entire repo. It turns sprawling codeb |
| 33 | [matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) | 1846 | Go | 2026-06-16 | AI-native HTAP database with Git-for-Data and built-in vector search, serving as the data and memory backbone for intell |
| 34 | [manasaghattamaneni/complianceiq](https://github.com/manasaghattamaneni/complianceiq) | 0 | Python | 2026-06-16 | RAG-based compliance document analyzer — grounded Q&A, checklist generation, and gap analysis. Python · Streamlit · Chro |
| 35 | [datalevin/datalevin](https://github.com/datalevin/datalevin) | 1435 | Clojure | 2026-06-16 | A simple, fast and versatile Datalog database |
| 36 | [somenath203/NeuroPad](https://github.com/somenath203/NeuroPad) | 0 | JavaScript | 2026-06-16 |  |
| 37 | [nguyenquoaca-hash/agentic-mesh](https://github.com/nguyenquoaca-hash/agentic-mesh) | 1 | HTML | 2026-06-16 | Multi-Agent AI Orchestrator 2026 🚀 \| YAML, 6+ LLM Providers, ReAct & Swarm |
| 38 | [Rishabh150102/DeepLearning-RAG-Chatbot](https://github.com/Rishabh150102/DeepLearning-RAG-Chatbot) | 0 | TypeScript | 2026-06-16 | AI-powered RAG chatbot built with LangChain, FastAPI, ChromaDB, and Next.js for semantic PDF question answering with sou |
...
| 46 | [JaeHoYun/vcf-rag-reference-architecture](https://github.com/JaeHoYun/vcf-rag-reference-architecture) | 0 | — | 2026-06-16 | VCF 9.1 Private AI 엔드투엔드 RAG 레퍼런스 아키텍처 (VectorDB→서빙→앱 통합 / PAIF 9.1 / PAIS 2.1) |
| 47 | [rehan243/rehan243](https://github.com/rehan243/rehan243) | 0 | — | 2026-06-16 | Profile README |
| 48 | [crate/crate](https://github.com/crate/crate) | 4410 | Java | 2026-06-16 | CrateDB is a distributed and scalable SQL database for storing and analyzing massive amounts of data in near real-time,  |
| 49 | [mixpeek/mixpeek-extractors](https://github.com/mixpeek/mixpeek-extractors) | 0 | Python | 2026-06-16 | Multimodal extractors for video, image, audio, text & PDF — turn any file into searchable vector embeddings (SigLIP, Gem |
| 50 | [JaeHoYun/vcf-dsm-vectordb-guide](https://github.com/JaeHoYun/vcf-dsm-vectordb-guide) | 0 | — | 2026-06-16 | VCF 9.1 Private AI용 엔터프라이즈 벡터 DB 가이드 — DSM PostgreSQL + pgvector (시리즈 ② 데이터) |
<!-- TRACKER_TABLE_END -->

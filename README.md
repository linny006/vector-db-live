...
| 17 | [subin-in/AI-Agents-with-LLMs](https://github.com/subin-in/AI-Agents-with-LLMs) | 0 | Python | 2026-08-17 | Hands-on AI Agents with LLMs covering tool calling, memory, multi-step workflows, semantic search, RAG agents, and a com |
...
| 20 | [thammarongg/blueocean-vector](https://github.com/thammarongg/blueocean-vector) | 0 | Python | 2026-08-17 | Shared, persistent vector memory over MCP — give Claude Code, Cursor, Codex, and other agents a common long-term memory  |
| 21 | [sattyamjjain/mnemo](https://github.com/sattyamjjain/mnemo) | 4 | Rust | 2026-08-17 | MCP-native embedded memory database for AI agents built in Rust. REMEMBER/RECALL/FORGET/SHARE primitives with hybrid vec |
...
| 24 | [SUBHASHSUSHIL/RAG](https://github.com/SUBHASHSUSHIL/RAG) | 0 | — | 2026-08-17 | A structured guide covering LLMs - architecture, capabilities, types, and how RAG enhances them |
| 25 | [thaletto/cortex](https://github.com/thaletto/cortex) | 2 | TypeScript | 2026-08-17 | The ORM for Vector Databases |
...
| 27 | [Cognipeer/console](https://github.com/Cognipeer/console) | 23 | TypeScript | 2026-08-17 | Open-source, self-hosted AI gateway for multi-tenant orgs: OpenAI-compatible LLM routing, RAG & vector stores, MCP hub,  |
...
| 29 | [Yasou13/MESA](https://github.com/Yasou13/MESA) | 5 | Python | 2026-08-17 | An asynchronous memory engine for enterprise AI agents, statistically minimizing hallucinations via dual-LLM consensus |
| 30 | [xerj-org/xerj](https://github.com/xerj-org/xerj) | 1406 | Rust | 2026-08-17 | XERJ is the new way for AI to search data. Its autoindex capability activates agents to know your data without the token |
| 31 | [worka-ai/anvil](https://github.com/worka-ai/anvil) | 77 | Rust | 2026-08-17 | Object storage for the AI age |
| 32 | [matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) | 1877 | Go | 2026-08-17 | AI-native HTAP database with Git-for-Data and built-in vector search, serving as the data and memory backbone for intell |
...
| 34 | [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex) | 35220 | Python | 2026-08-17 | 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG |
...
| 36 | [naveed-data/agentic-rag-supervisor](https://github.com/naveed-data/agentic-rag-supervisor) | 0 | Python | 2026-08-17 |  Agentic RAG system with a LangGraph supervisor that routes each query to the right tool — document retrieval, Wikipedia |
| 37 | [ArcadeData/arcadedb](https://github.com/ArcadeData/arcadedb) | 1085 | Java | 2026-08-17 | ArcadeDB Multi-Model Database, one DBMS that supports SQL, Cypher, Gremlin, HTTP/JSON, MongoDB and Redis. ArcadeDB is a  |
| 38 | [HelixDB/helix-db](https://github.com/HelixDB/helix-db) | 5744 | Rust | 2026-08-17 | HelixDB is an OLTP graph-vector database built in Rust on Object Storage. |
| 39 | [Brainwires/rsqlite-wasm](https://github.com/Brainwires/rsqlite-wasm) | 2 | Rust | 2026-08-17 | WASM implementation of sqlite, with vector database support; written in Rust. |
| 40 | [Tunolabs/xyzdb](https://github.com/Tunolabs/xyzdb) | 7 | Rust | 2026-08-17 | Semantic gravity database in Rust: related records live together on disk, so graph traversal is a range scan and vector  |
| 41 | [sindrehaugen/NCE](https://github.com/sindrehaugen/NCE) | 0 | Python | 2026-08-17 | More than a vector index with a search() bolted on: a cognitive memory engine for AI agents that consolidates, forgets a |
| 42 | [infinispan/infinispan](https://github.com/infinispan/infinispan) | 1344 | Java | 2026-08-17 | Infinispan is an open source data grid platform and highly scalable NoSQL cloud data store. |
| 43 | [TheAmitChandra/NeuralCleave](https://github.com/TheAmitChandra/NeuralCleave) | 4 | Python | 2026-08-17 | Your personal AI assistant, powered by the models you choose. Connect leading AI providers and messaging platforms throu |
| 44 | [vespa-engine/vespa](https://github.com/vespa-engine/vespa) | 7052 | Java | 2026-08-17 | The AI search platform |
| 45 | [CogKnowEdge-Solutions/Context-Memory-Layer](https://github.com/CogKnowEdge-Solutions/Context-Memory-Layer) | 0 | Jupyter Notebook | 2026-08-17 | A persistent context and memory layer that gives agents short-term conversation context, long-term knowledge, episodic e |
| 46 | [weaviate/weaviate](https://github.com/weaviate/weaviate) | 16734 | Go | 2026-08-17 | Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector  |
| 47 | [sergiunicoara/Generative-AI](https://github.com/sergiunicoara/Generative-AI) | 3 | Python | 2026-08-17 | Production GraphRAG portfolio — knowledge graph platform (Neo4j, hybrid retrieval, GNN reranking, RAGAS-evaluated), RAG  |
| 48 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 34029 | Rust | 2026-08-17 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
| 49 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | 45666 | Go | 2026-08-17 | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search |
| 50 | [lioensky/VCPToolBox](https://github.com/lioensky/VCPToolBox) | 2255 | JavaScript | 2026-08-17 | VCP 部署在 AI 模型 API 与前端应用之间，是面向AGI OS开发和探索的工业级基建示范项目。通过统一指令协议、多层级持久化记忆、分布式插件引擎及多 Agent 协作框架，将原本“无状态、无记忆、无工具调用能力”的大语言模型，彻底改 |
<!-- TRACKER_TABLE_END -->

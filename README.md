...
| 24 | [nacre-work/nacre](https://github.com/nacre-work/nacre) | 0 | TypeScript | 2026-08-10 | Self-hosted permission-aware context layer for agents. MCP + API. |
...
| 26 | [MariaDB/server](https://github.com/MariaDB/server) | 8069 | C++ | 2026-08-10 | MariaDB server is a community developed fork of MySQL server. Started by core members of the original MySQL team, MariaD |
| 27 | [bcastelino/sec-filing-room](https://github.com/bcastelino/sec-filing-room) | 1 | TypeScript | 2026-08-10 | Built a RAG chatbot using free LLMs, Streamlit, and VectorDB to query chunked SEC EDGAR financial data, designed an embe |
| 28 | [thaletto/cortex](https://github.com/thaletto/cortex) | 2 | TypeScript | 2026-08-10 | The ORM for Vector Databases |
| 29 | [jihadkhawaja/mem0sharp](https://github.com/jihadkhawaja/mem0sharp) | 11 | C# | 2026-08-10 | A standalone memory engine for AI agents in .NET, with hybrid retrieval, graph memory, pluggable providers, and behavior |
| 30 | [gouthambilluri02/agentic-financial-intelligence-system](https://github.com/gouthambilluri02/agentic-financial-intelligence-system) | 0 | Python | 2026-08-10 | Enterprise-grade Agentic AI Financial Intelligence System built with FastAPI, React, ChromaDB, Ollama, and Retrieval-Aug |
| 31 | [monaccode/astromesh](https://github.com/monaccode/astromesh) | 30 | Python | 2026-08-10 | Multi-model AI agent runtime. Define agents in YAML, route each role to a model, orchestrate with 7 patterns (ReAct, Pla |
| 32 | [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | 64566 | JavaScript | 2026-08-10 | Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-first agent experience |
| 33 | [RonsenbergVI/fraise](https://github.com/RonsenbergVI/fraise) | 2 | Go | 2026-08-10 | In-memory knowledge store for AI agents |
| 34 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 33904 | Rust | 2026-08-10 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
| 35 | [Artemon-line/ai-memory-hub](https://github.com/Artemon-line/ai-memory-hub) | 2 | Python | 2026-08-10 | Local-first shared memory for AI agents, with MCP and HTTP APIs. |
| 36 | [LnYo-Cly/ai4j](https://github.com/LnYo-Cly/ai4j) | 422 | Java | 2026-08-10 | Java 8+ agentic SDK: unified LLM access (OpenAI/Anthropic/DashScope/Doubao/DeepSeek...), Tool Calling, MCP, RAG, Agent R |
| 37 | [agent-ix/ecaz](https://github.com/agent-ix/ecaz) | 2 | Rust | 2026-08-10 | Rust PostgreSQL extension for high-performance vector storage with broad quantization and index support. |
| 38 | [topoteretes/cognee](https://github.com/topoteretes/cognee) | 29930 | Python | 2026-08-10 | Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions |
| 39 | [Rangineni-png/ai-data-engineer-rag-roadmap](https://github.com/Rangineni-png/ai-data-engineer-rag-roadmap) | 0 | Python | 2026-08-10 | End-to-end local RAG pipeline for company policy question answering using Python, ChromaDB, Sentence Transformers, Ollam |
...
| 42 | [elifyagmurduran/LLMvectoRAG-product-classifier](https://github.com/elifyagmurduran/LLMvectoRAG-product-classifier) | 0 | Python | 2026-08-10 | RAG assisted LLM tool and vector embeddings creator for AI enrichment pipeline, to assign GS1 standard categories into m |
...
| 44 | [Shikhar-code/memcoder](https://github.com/Shikhar-code/memcoder) | 1 | Python | 2026-08-10 | Provider-independent persistent cognition layer for AI agents. |
...
| 46 | [gupta29470/codewalk](https://github.com/gupta29470/codewalk) | 5 | Python | 2026-08-10 | AI-powered codebase onboarding tool — point it at any repo and ask questions about the code. Uses tree-sitter parsing, R |
| 47 | [Toskurim/vector-unforget](https://github.com/Toskurim/vector-unforget) | 2 | Python | 2026-08-10 | GDPR/CCPA Right-to-be-Forgotten Engine for Vector Databases (ChromaDB, Qdrant, Pgvector) with Global PII Extraction, Dry |
| 48 | [api-evangelist/machine-learning](https://github.com/api-evangelist/machine-learning) | 0 | HTML | 2026-08-10 | API platform info for machine-learning |
| 49 | [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 6562 | Python | 2026-08-10 |  Memory library for building stateful agents |
| 50 | [yp3y5akh0v/citadel](https://github.com/yp3y5akh0v/citadel) | 3 | Rust | 2026-08-10 | Local-first encrypted memory for AI agents |
<!-- TRACKER_TABLE_END -->

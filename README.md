...
| 17 | [mmnto-ai/totem](https://github.com/mmnto-ai/totem) | 16 | TypeScript | 2026-08-04 | Rules you can enforce, state you can derive, context you can query: plain files in your repo, under whichever coding age |
| 18 | [ElefanteAI/elefante](https://github.com/ElefanteAI/elefante) | 1 | Python | 2026-08-04 | Elefante never forgets. The Second Brain for AI Agents. Local-first persistent memory engine via MCP (ChromaDB + Kuzu).  |
| 19 | [ModuleXAI/modulex-integrations](https://github.com/ModuleXAI/modulex-integrations) | 25 | Python | 2026-08-04 | 175+ pip-installable tool integrations for the ModuleX runtime — one pydantic manifest contract, entry-point discovery,  |
...
| 21 | [nacre-work/nacre](https://github.com/nacre-work/nacre) | 0 | TypeScript | 2026-08-04 | Self-hosted permission-aware context layer for agents. MCP + API. |
| 22 | [Thitrongdan202/MediSearch-with-Chroma-DB](https://github.com/Thitrongdan202/MediSearch-with-Chroma-DB) | 2 | Jupyter Notebook | 2026-08-04 | This intelligent drug analysis platform uses ChromaDB and AI to search for and analyze drugs. |
| 23 | [weaviate/weaviate](https://github.com/weaviate/weaviate) | 16693 | Go | 2026-08-04 | Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector  |
| 24 | [xerj-org/xerj](https://github.com/xerj-org/xerj) | 1064 | Rust | 2026-08-04 | XERJ is the new way for AI to search data. Its autoindex capability activates agents to know your data without the token |
| 25 | [litegraphdb/litegraph](https://github.com/litegraphdb/litegraph) | 127 | C# | 2026-08-04 | Lightweight graph database with relational, vector, and MCP support, designed to power knowledge and artificial intellig |
| 26 | [rayperatta/rag-document-qa](https://github.com/rayperatta/rag-document-qa) | 0 | Python | 2026-08-04 | Production-ready RAG system for PDF Q&A — LangChain + ChromaDB + FastAPI |
...
| 34 | [PerinbaBuilds/Semantic-RAG-Search](https://github.com/PerinbaBuilds/Semantic-RAG-Search) | 0 | Python | 2026-08-04 | RAG pipeline over 18,000+ Usenet posts from 1993 — semantic search, query rewriting, document grading, FCM cache, and RA |
| 35 | [ever-works/awesome-vector-databases](https://github.com/ever-works/awesome-vector-databases) | 26 | — | 2026-08-04 | A curated list of vector database solutions, libraries, and resources for AI applications - https://vectordb.ever.works |
| 36 | [chandra-vv/genai_portfolio](https://github.com/chandra-vv/genai_portfolio) | 2 | Python | 2026-08-04 | Generative AI Engineering Portfolio — RAG, Memory, Agents, LangChain, LangGraph |
| 37 | [topoteretes/cognee](https://github.com/topoteretes/cognee) | 29778 | Python | 2026-08-04 | Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions |
...
| 39 | [siaarzh/scrybe](https://github.com/siaarzh/scrybe) | 3 | TypeScript | 2026-08-04 | Self-hosted semantic code search. Index repos and knowledge sources into a local vector DB, then search by natural langu |
| 40 | [Adedejiosvaldo/rag-chunker](https://github.com/Adedejiosvaldo/rag-chunker) | 0 | Go | 2026-08-04 | ⚡ Blazingly fast, lightweight Go REST API & SDK for text chunking in RAG (Retrieval-Augmented Generation) pipelines. |
| 41 | [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 6427 | Python | 2026-08-04 |  Memory library for building stateful agents |
| 42 | [hivellm/vectorizer](https://github.com/hivellm/vectorizer) | 27 | Rust | 2026-08-04 | A high-performance, in-memory vector database written in Rust, designed for semantic search and top-k nearest neighbor q |
| 43 | [SynapseKit/SynapseKit](https://github.com/SynapseKit/SynapseKit) | 21 | Python | 2026-08-04 | Minimal, async-first Python framework for production LLM apps- 2 hard deps, no magic, no SaaS.  |
| 44 | [laiba-mazhar/ragforge](https://github.com/laiba-mazhar/ragforge) | 0 | Python | 2026-08-04 | Hybrid retrieval (dense + BM25 + RRF) with a built-in evaluation harness — measure your RAG instead of guessing. Chroma/ |
| 45 | [yantrikos/yantrikdb-mcp](https://github.com/yantrikos/yantrikdb-mcp) | 24 | Python | 2026-08-04 | Persistent cognitive memory for AI agents — drop-in MCP server for Claude Code, Cursor, Windsurf. Temporal decay, contra |
| 46 | [Vamshi868876/Secure-Enterprise-RAG](https://github.com/Vamshi868876/Secure-Enterprise-RAG) | 0 | CSS | 2026-08-04 | A production-grade Secure Enterprise RAG Architecture featuring Role-Based Access Control (RBAC), JWT Authentication, an |
| 47 | [Shahzain-Ali/agentive-solutions-book](https://github.com/Shahzain-Ali/agentive-solutions-book) | 0 | Python | 2026-08-04 | Agentive Solutions interactive book — AI automation courses starting with n8n Mastery |
| 48 | [tradik/mddb](https://github.com/tradik/mddb) | 3 | Go | 2026-08-04 | A minimal, lightweight structured data store designed for small applications, scripts and automation workflows. Built fo |
| 49 | [StephenSook/erasure-proof](https://github.com/StephenSook/erasure-proof) | 0 | Go | 2026-08-04 | Provable, statute-compliant crypto-erasure for AI agent memory on CockroachDB and AWS |
| 50 | [RonsenbergVI/fraise](https://github.com/RonsenbergVI/fraise) | 2 | Go | 2026-08-04 | In-memory knowledge store for AI agents |
<!-- TRACKER_TABLE_END -->

...
| 11 | [liliang-cn/cortexdb](https://github.com/liliang-cn/cortexdb) | 38 | Go | 2026-06-17 | A pure-Go, single-file AI memory and knowledge graph library.  |
| 12 | [ihimanshu29/Agentic-AI-Lucknow-Guide-FastAPI](https://github.com/ihimanshu29/Agentic-AI-Lucknow-Guide-FastAPI) | 4 | Python | 2026-06-17 | An enterprise-grade, full-stack AI travel planner which provides data-driven itineraries for Lucknow, India and showcase |
...
| 14 | [crate/crate](https://github.com/crate/crate) | 4410 | Java | 2026-06-17 | CrateDB is a distributed and scalable SQL database for storing and analyzing massive amounts of data in near real-time,  |
...
| 16 | [Neverdecel/CodeRAG](https://github.com/Neverdecel/CodeRAG) | 212 | Python | 2026-06-17 | Local-first, zero-key semantic code search for large and custom codebases — hybrid vector + keyword retrieval with symbo |
...
| 18 | [ducklelabs/duckle](https://github.com/ducklelabs/duckle) | 527 | Rust | 2026-06-17 | Local-first ETL/ELT studio: a drag-and-drop visual pipeline designer that compiles to SQL and runs on DuckDB. Tiny deskt |
| 19 | [Susanta2025-lab/estudio-polymind-llm-orchestration](https://github.com/Susanta2025-lab/estudio-polymind-llm-orchestration) | 0 | Python | 2026-06-17 | Local AI infrastructure for multi-LLM RAG, vector search, and agentic workflows. Combines Ollama, FastAPI, ChromaDB, and |
...
| 21 | [kashyapsundaragiri/LangChain-Study-Repository](https://github.com/kashyapsundaragiri/LangChain-Study-Repository) | 0 | Jupyter Notebook | 2026-06-17 | **LangChain learning repository featuring hands-on notebooks, experiments, and study notes on data ingestion, text split |
| 22 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | 44809 | Go | 2026-06-17 | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search |
| 23 | [Dakera-AI/dakera-py](https://github.com/Dakera-AI/dakera-py) | 2 | Python | 2026-06-17 | Python SDK for Dakera AI agent memory — self-hosted, 88.2% LoCoMo. Vectors, hybrid search, knowledge graphs, sessions. |
...
| 32 | [davidcjw/career-copilot](https://github.com/davidcjw/career-copilot) | 0 | Python | 2026-06-17 | Agentic resume-tailoring & gap-analysis tool — LangGraph, RAG (pgvector), and LangSmith observability |
...
| 34 | [lancedb/lancedb](https://github.com/lancedb/lancedb) | 10628 | HTML | 2026-06-17 | Developer-friendly OSS embedded retrieval library for multimodal AI. Search More; Manage Less. |
...
| 36 | [ersinisgor/AI-Knowledge-Base-Assistant](https://github.com/ersinisgor/AI-Knowledge-Base-Assistant) | 0 | TypeScript | 2026-06-17 |  |
...
| 38 | [StarTrail-org/LEANN](https://github.com/StarTrail-org/LEANN) | 12002 | Python | 2026-06-17 | [MLsys2026]: RAG on Everything with LEANN. Enjoy 97% storage savings while running a fast, accurate, and 100% private RA |
| 39 | [langchain4j/langchain4j](https://github.com/langchain4j/langchain4j) | 12355 | Java | 2026-06-17 | LangChain4j is an idiomatic, open-source Java library for building LLM-powered applications on the JVM. It offers a unif |

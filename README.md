...
| 11 | [ArcadeData/arcadedb](https://github.com/ArcadeData/arcadedb) | 1030 | Java | 2026-07-19 | ArcadeDB Multi-Model Database, one DBMS that supports SQL, Cypher, Gremlin, HTTP/JSON, MongoDB and Redis. ArcadeDB is a  |
| 12 | [K2alyan/aksharaMD](https://github.com/K2alyan/aksharaMD) | 7 | Python | 2026-07-19 | LLM document ingestion pipeline with AI readiness scoring and structured Markdown/JSON output. |
| 13 | [kamrankhanorakzai/hospitality-rag-agent](https://github.com/kamrankhanorakzai/hospitality-rag-agent) | 0 | HTML | 2026-07-19 | AI-powered hotel front desk assistant with n8n automation, chat widget UI, and hotel data retrieval for rooms, rates, am |
...
| 15 | [cyberlife-coder/VelesDB](https://github.com/cyberlife-coder/VelesDB) | 75 | Rust | 2026-07-19 | The explainable, local-first memory engine for AI agents. One ~9 MB binary fuses vector + graph + columnar under VelesQL |
...
| 18 | [piyalidas10/AI](https://github.com/piyalidas10/AI) | 0 | Python | 2026-07-19 | GEN AI Playground : Sample development & integration of Ollama, RAG, Langchain, LagGraph, FastAPI using Docker |
| 19 | [integrallis/vectors](https://github.com/integrallis/vectors) | 0 | Java | 2026-07-19 | The Ultimate Vectors Library for Java |
| 20 | [monaccode/astromesh](https://github.com/monaccode/astromesh) | 30 | Python | 2026-07-19 | Multi-model AI agent runtime. Define agents in YAML, connect 6 LLM providers, orchestrate with ReAct/Plan&Execute/Fan-Ou |
| 21 | [AleksNeStu/ai-real-estate-assistant](https://github.com/AleksNeStu/ai-real-estate-assistant) | 283 | Python | 2026-07-19 | AI-powered real estate platform with conversational property search, analytics, and market insights. Built with FastAPI  |
...
| 29 | [KatherineMossDeveloper/Midnight-Train](https://github.com/KatherineMossDeveloper/Midnight-Train) | 1 | TypeScript | 2026-07-19 | A browser app presenting data from the Georgia Project.  |
| 30 | [anmolsharma152/PsyRAG](https://github.com/anmolsharma152/PsyRAG) | 0 | Python | 2026-07-19 | Domain-adapted RAG over cognitive psychology literature — query expansion, parallel retrieval, and FAISS vector search p |
| 31 | [mienetic/mnema](https://github.com/mienetic/mnema) | 3 | Python | 2026-07-19 | 🧠 Mnema — Long-term memory for AI via MCP × Vector DB. Pluggable backends, hybrid search, Auto Dream consolidation, CLI  |
...
| 34 | [Bhavyakruthi/VioletAI-Multi-Agent-Financial-Analysis-System](https://github.com/Bhavyakruthi/VioletAI-Multi-Agent-Financial-Analysis-System) | 1 | Python | 2026-07-19 | An AI-powered multi-agent financial research platform that combines market data, sentiment analysis, forecasting, RAG, a |
| 35 | [vearch/vearch](https://github.com/vearch/vearch) | 2318 | Go | 2026-07-19 | Distributed vector search for AI-native applications |
| 36 | [perforate-org/gleaph](https://github.com/perforate-org/gleaph) | 1 | Rust | 2026-07-19 | Decentralized Graph Database with Integrated Vector Search |
| 37 | [Omni-Kernel/OS](https://github.com/Omni-Kernel/OS) | 0 | — | 2026-07-19 | Autonomous Revenue Operating System (v7.2.0) powered by a 5-node AI swarm, Bayesian probability engines, and Kelly Crite |
| 38 | [dovahkiin-v/mitos](https://github.com/dovahkiin-v/mitos) | 3 | Python | 2026-07-19 | LLM-native architecture decision record (ADR) tracking. Prevents Agents from repeating mistakes. SQLite + Qdrant + MCP.  |
| 39 | [DeveloperChetram/Contextual_Chatbot_React](https://github.com/DeveloperChetram/Contextual_Chatbot_React) | 0 | JavaScript | 2026-07-19 | Atomic is a full-stack AI-powered contextual chatbot application built with React, Node.js, and Google Gemini AI. The ap |
...
| 41 | [giuliano0s/ifrs-canoas-rag](https://github.com/giuliano0s/ifrs-canoas-rag) | 0 | Python | 2026-07-19 |  |
| 42 | [codecoradev/uteke](https://github.com/codecoradev/uteke) | 116 | Rust | 2026-07-19 | 🧠 The Brain for Your AI — Local-first memory engine for AI agents. Store, recall, and search memories with semantic embe |
| 43 | [veawho/via54ADIdeahub](https://github.com/veawho/via54ADIdeahub) | 1 | Python | 2026-07-19 | 医学传播创意向量知识库 — 语义检索 RAG + 52个全球创意案例深度报告 |
| 44 | [veep2012/doc_mcp](https://github.com/veep2012/doc_mcp) | 0 | Python | 2026-07-19 | Local MCP server for authenticated documentation sites, using Playwright for login and crawling, SQLite full-text and ve |
| 45 | [weaviate/weaviate](https://github.com/weaviate/weaviate) | 16617 | Go | 2026-07-19 | Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector  |
| 46 | [prerna-m01/Multi-Agent-Research-Assistant](https://github.com/prerna-m01/Multi-Agent-Research-Assistant) | 0 | Python | 2026-07-19 | AI-powered Multi-Agent Research Assistant built with FastAPI, Gemini, Tavily, and RAG. Supports automated research, PDF- |
| 47 | [LEKKALAGANESH/sports-quiz-rag-agent](https://github.com/LEKKALAGANESH/sports-quiz-rag-agent) | 0 | Python | 2026-07-19 | A sports quiz generator powered by RAG technology that combines ChromaDB vector search with live DuckDuckGo results, fea |
| 48 | [context-graph-ai/contextdb](https://github.com/context-graph-ai/contextdb) | 19 | Rust | 2026-07-19 | Embedded database for agentic memory — relational, graph, and vector under unified MVCC transactions |
| 49 | [StephenCote/AccountManager7](https://github.com/StephenCote/AccountManager7) | 2 | JavaScript | 2026-07-19 | Identity and Authorization Service with Vector and AI Integration |
| 50 | [lioensky/VCPToolBox](https://github.com/lioensky/VCPToolBox) | 2193 | JavaScript | 2026-07-19 | VCP 部署在 AI 模型 API 与前端应用之间，是面向AGI OS开发和探索的工业级基建示范项目。通过统一指令协议、多层级持久化记忆、分布式插件引擎及多 Agent 协作框架，将原本“无状态、无记忆、无工具调用能力”的大语言模型，彻底改 |
<!-- TRACKER_TABLE_END -->

...
| 23 | [AliSajadian/agentica](https://github.com/AliSajadian/agentica) | 0 | Python | 2026-06-11 | Production-grade agentic AI orchestration platform — RAG, LLM inference, and multi-agent workflows with FastAPI, Ollama, |
| 24 | [TranTungDuong02082006/autonomous-researcher](https://github.com/TranTungDuong02082006/autonomous-researcher) | 1 | Python | 2026-06-11 | 🚀 Advanced multi-agent autonomous framework for deep research, self-reflective peer review, and citation-accurate report |
...
| 26 | [23skdu/longbow](https://github.com/23skdu/longbow) | 13 | Go | 2026-06-11 | Apache Arrow Flight clustered vector engine for high throughput Agent memory sharing  |
...
| 28 | [marco-spagn/pcmi](https://github.com/marco-spagn/pcmi) | 4 | Go | 2026-06-11 | Persistent Cognitive Memory Infrastructure — durable, multi-tenant memory layer for AI agents. HTTP + gRPC, hybrid retri |
| 29 | [djleamen/doc-reader](https://github.com/djleamen/doc-reader) | 2 | Python | 2026-06-11 | Large document Q&A agent using RAG |
| 30 | [jkraybill/gordo-ledger](https://github.com/jkraybill/gordo-ledger) | 0 | TypeScript | 2026-06-11 | Semantic memory and cross-project search for AI |
| 31 | [AleksNeStu/ai-real-estate-assistant](https://github.com/AleksNeStu/ai-real-estate-assistant) | 205 | Python | 2026-06-11 | AI-powered real estate platform with conversational property search, analytics, and market insights. Built with FastAPI  |
| 32 | [jourdaninorder609/mind-query](https://github.com/jourdaninorder609/mind-query) | 0 | TypeScript | 2026-06-11 | Convert natural language into SQL and MQL queries for PostgreSQL, MySQL, SQL Server, and MongoDB using an MCP-enabled ag |
| 33 | [MariaDB/server](https://github.com/MariaDB/server) | 7720 | C++ | 2026-06-11 | MariaDB server is a community developed fork of MySQL server. Started by core members of the original MySQL team, MariaD |
...
| 36 | [yantrikos/yantrikdb](https://github.com/yantrikos/yantrikdb) | 33 | Rust | 2026-06-11 | Cognitive memory engine for AI agents — temporal decay, contradiction detection, autonomous consolidation, knowledge gra |
| 37 | [Monkish-jewishryebread665/NodeMind](https://github.com/Monkish-jewishryebread665/NodeMind) | 0 | HTML | 2026-06-11 | Replace vector databases with binary document intelligence for efficient multimodal data search without GPUs. |
| 38 | [Surging-scotandlot818/product-dev-blueprint](https://github.com/Surging-scotandlot818/product-dev-blueprint) | 0 | TypeScript | 2026-06-11 | Transform software concepts into structured build plans with this schema-first product planning tool for engineering tea |
| 39 | [Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker](https://github.com/Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker) | 0 | Dockerfile | 2026-06-11 | Build a multi-collection RAG system using LlamaIndex and Qdrant in a Docker environment. |
| 40 | [lopadova/AskMyDocs](https://github.com/lopadova/AskMyDocs) | 1 | PHP | 2026-06-11 | AI Hub & Intelligent Agentic Platform for the Enterprise - self-hostable AI hub for enterprise knowledge. |
...
| 44 | [exact-treesquirrel5419/ai_osint](https://github.com/exact-treesquirrel5419/ai_osint) | 2 | — | 2026-06-11 | Discover exposed AI infrastructure including LLMs, agents, and ML pipelines using curated OSINT dorks, queries, and reco |
| 45 | [jefffergunson118-beep/smara](https://github.com/jefffergunson118-beep/smara) | 1 | — | 2026-06-11 | Sync persistent memory across your AI tools and agents using a unified MCP server. |
| 46 | [unohee/OpenSwarm](https://github.com/unohee/OpenSwarm) | 804 | TypeScript | 2026-06-11 | OpenSwarm — Autonomous AI dev team orchestrator powered by Claude Code CLI. Discord control, Linear integration, cogniti |
| 47 | [sarcosomebankcheck694/coordinode](https://github.com/sarcosomebankcheck694/coordinode) | 0 | Rust | 2026-06-11 | Unify graph, vector, and full-text search in one Rust engine for GraphRAG and AI retrieval with OpenCypher and MVCC |
| 48 | [Tobiaszn8972/turboquant-gpu](https://github.com/Tobiaszn8972/turboquant-gpu) | 2 | Python | 2026-06-11 | Compress KV cache for LLM inference with 5.02x efficiency on NVIDIA GPUs using cuTile kernels. |
...
| 50 | [viviannenitrogenous100/mentedb](https://github.com/viviannenitrogenous100/mentedb) | 0 | — | 2026-06-11 | Build an AI memory database for agents with a Rust storage engine designed for LLM data and fast retrieval |
<!-- TRACKER_TABLE_END -->

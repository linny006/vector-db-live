...
| 2 | [StephenCote/AccountManager7](https://github.com/StephenCote/AccountManager7) | 2 | JavaScript | 2026-06-20 | Identity and Authorization Service with Vector and AI Integration |
| 3 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | 44849 | Go | 2026-06-20 | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search |
| 4 | [Buffden/rag-document-engine](https://github.com/Buffden/rag-document-engine) | 1 | Python | 2026-06-20 |  A progressive RAG system built from scratch in Python, starting from raw embeddings and cosine similarity, evolving int |
...
| 15 | [sazFreelancer/ai-rag-platform-blueprint](https://github.com/sazFreelancer/ai-rag-platform-blueprint) | 0 | Python | 2026-06-20 | AI, LLM, and RAG platform infrastructure blueprint with Docker Compose, routing, storage, and observability notes. |
...
| 41 | [api-evangelist/aerospike](https://github.com/api-evangelist/aerospike) | 0 | — | 2026-06-20 | API and integration profile for Aerospike. |
| 42 | [BirchKwok/lynsedb](https://github.com/BirchKwok/lynsedb) | 40 | Rust | 2026-06-20 | Embedded-first vector database that grows into a self-hosted service and lightweight cluster. |
| 43 | [perforate-org/gleaph](https://github.com/perforate-org/gleaph) | 1 | Rust | 2026-06-20 | Decentralized Graph Database with Integrated Vector Search |
| 44 | [genkit-ai/genkit](https://github.com/genkit-ai/genkit) | 6131 | TypeScript | 2026-06-20 | Open-source framework for building AI-powered apps in JavaScript, Go, and Python, built and used in production by Google |
| 45 | [sirben01/RagDemo](https://github.com/sirben01/RagDemo) | 0 | C# | 2026-06-20 | A RAG (Retrieval Augmented Generation) demo — crawl any website, index it into Qdrant, and chat with it using Claude. Bu |
| 46 | [al7o/DocuMind-AI-Engine](https://github.com/al7o/DocuMind-AI-Engine) | 0 | HTML | 2026-06-20 | AI Document Analyzer 2026 📄✨ - Smart OCR & Data Extraction Tool |
...
| 48 | [zaahist/design-to-ship-playbook](https://github.com/zaahist/design-to-ship-playbook) | 0 | HTML | 2026-06-20 | AI Blueprint Generator 2026: PRDs to Agent Prompts in One Click |
| 49 | [run-llama/llama_index](https://github.com/run-llama/llama_index) | 50229 | Python | 2026-06-20 | LlamaIndex is the leading document agent and OCR platform |

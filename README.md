...
| 24 | [api-evangelist/mixedbread-ai](https://github.com/api-evangelist/mixedbread-ai) | 1 | — | 2026-07-30 | API Evangelist profile of Mixedbread - embeddings and reranking API |
| 25 | [api-evangelist/milvus](https://github.com/api-evangelist/milvus) | 0 | — | 2026-07-30 | Open-source cloud-native vector database. |
| 26 | [api-evangelist/marqo](https://github.com/api-evangelist/marqo) | 0 | — | 2026-07-30 | Vector search engine with end-to-end embedding and reranking. |
| 27 | [api-evangelist/lf-ai-and-data](https://github.com/api-evangelist/lf-ai-and-data) | 0 | — | 2026-07-30 | The LF AI & Data Foundation is a Linux Foundation umbrella that advances open source artificial intelligence, machine le |
| 28 | [api-evangelist/lancedb](https://github.com/api-evangelist/lancedb) | 0 | — | 2026-07-30 | LanceDB — open-source serverless multimodal vector database (Lance format) |
| 29 | [matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) | 1871 | Go | 2026-07-30 | AI-native HTAP database with Git-for-Data and built-in vector search, serving as the data and memory backbone for intell |
| 30 | [caoergou/dify-installer](https://github.com/caoergou/dify-installer) | 2 | Shell | 2026-07-30 | One-click installer for Dify Docker deployment \| Dify 一键安装脚本，使用 Docker Compose 部署 |
| 31 | [jmcgrath207/conproxy](https://github.com/jmcgrath207/conproxy) | 0 | — | 2026-07-30 |  |
| 32 | [zilliztech/VectorDBBench](https://github.com/zilliztech/VectorDBBench) | 1152 | Python | 2026-07-30 | Benchmark for vector databases. |
| 33 | [thekaveh/atlas](https://github.com/thekaveh/atlas) | 3 | Python | 2026-07-30 | Atlas — self-hosted, source-configurable, multi-disciplinary engineering platform for gen-AI, ML, and data work. 30+ OSS |
| 34 | [api-evangelist/azure-cosmos-db](https://github.com/api-evangelist/azure-cosmos-db) | 0 | — | 2026-07-30 | API and integration profile for Azure Cosmos DB. |
| 35 | [ADITYA22110016/document-copilot-mcp-nemotron](https://github.com/ADITYA22110016/document-copilot-mcp-nemotron) | 0 | Python | 2026-07-30 | RAG document assistant with a real MCP client-server architecture (Streamlit host + FastMCP server) powered by NVIDIA Ne |
| 36 | [api-evangelist/aerospike](https://github.com/api-evangelist/aerospike) | 0 | — | 2026-07-30 | API and integration profile for Aerospike. |
| 37 | [vp1410/opslens-ai](https://github.com/vp1410/opslens-ai) | 0 | Python | 2026-07-30 | MCP-powered RAG assistant for engineering incident investigation using Python, Streamlit, ChromaDB, semantic retrieval,  |
| 38 | [NVIDIA/cuvs-lucene](https://github.com/NVIDIA/cuvs-lucene) | 8 | Java | 2026-07-30 | A Lucene codec for vector search and clustering on the GPU |
| 39 | [sloptycoon/revive](https://github.com/sloptycoon/revive) | 0 | — | 2026-07-30 | Turn books, letters, and notebooks into AI personas grounded in the actual words — RAG architecture docs and examples |
...
| 41 | [CodeAbra/iai-personal-memory-engine](https://github.com/CodeAbra/iai-personal-memory-engine) | 476 | Python | 2026-07-30 | A cyber brain for your AI. It never forgets a detail, remembers exactly what you said, and learns how you work over time |
| 42 | [oscargbocanegra/llms-engineering-main](https://github.com/oscargbocanegra/llms-engineering-main) | 2 | Jupyter Notebook | 2026-07-30 | Applied LLM engineering portfolio with RAG, agents, and production-oriented AI workflows |
| 43 | [0xLazAI/alith](https://github.com/0xLazAI/alith) | 44 | Rust | 2026-07-30 | Simple, Composable, High-Performance, Safe and Web3 Friendly AI Agents and LazAI Gateway for Everyone |
| 44 | [yirongNg/Big-Data-Embedding-Semantic-Search-Pipeline](https://github.com/yirongNg/Big-Data-Embedding-Semantic-Search-Pipeline) | 0 | Jupyter Notebook | 2026-07-30 | End-to-end distributed AI Data Engineering pipeline using Databricks PySpark, OpenAI Embeddings, and Pinecone Vector DB  |
| 45 | [infiniflow/infinity](https://github.com/infiniflow/infinity) | 4652 | C++ | 2026-07-30 | The AI-native database built for LLM applications, providing incredibly fast hybrid search of dense vector, sparse vecto |
...
| 47 | [MontyGovernance/montycat_rust](https://github.com/MontyGovernance/montycat_rust) | 1 | Rust | 2026-07-30 | AI-native NoSQL + vector database with built-in semantic search for RAG, AI agents & LLM memory — the async Rust client. |
| 48 | [MontyGovernance/montycat_python](https://github.com/MontyGovernance/montycat_python) | 2 | Python | 2026-07-30 | AI-native NoSQL + vector database with built-in semantic search for RAG, AI agents & LLM memory — the async Python clien |
| 49 | [MontyGovernance/montycat_node](https://github.com/MontyGovernance/montycat_node) | 2 | TypeScript | 2026-07-30 | AI-native NoSQL + vector database with built-in semantic search for RAG, AI agents & LLM memory — the Node.js & TypeScri |
| 50 | [MontyGovernance/montycat_dart](https://github.com/MontyGovernance/montycat_dart) | 3 | Dart | 2026-07-30 | AI-native NoSQL + vector database with built-in semantic search for RAG & AI agents — the Dart & Flutter client. Self-ho |
<!-- TRACKER_TABLE_END -->

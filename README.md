...
| 18 | [infinispan/infinispan](https://github.com/infinispan/infinispan) | 1344 | Java | 2026-08-17 | Infinispan is an open source data grid platform and highly scalable NoSQL cloud data store. |
| 19 | [TheAmitChandra/NeuralCleave](https://github.com/TheAmitChandra/NeuralCleave) | 4 | Python | 2026-08-17 | Your personal AI assistant, powered by the models you choose. Connect leading AI providers and messaging platforms throu |
| 20 | [vespa-engine/vespa](https://github.com/vespa-engine/vespa) | 7052 | Java | 2026-08-17 | The AI search platform |
| 21 | [CogKnowEdge-Solutions/Context-Memory-Layer](https://github.com/CogKnowEdge-Solutions/Context-Memory-Layer) | 0 | Jupyter Notebook | 2026-08-17 | A persistent context and memory layer that gives agents short-term conversation context, long-term knowledge, episodic e |
| 22 | [weaviate/weaviate](https://github.com/weaviate/weaviate) | 16734 | Go | 2026-08-17 | Weaviate is an open-source vector database that stores both objects and vectors, allowing for the combination of vector  |
...
| 25 | [sergiunicoara/Generative-AI](https://github.com/sergiunicoara/Generative-AI) | 3 | Python | 2026-08-17 | Production GraphRAG portfolio — knowledge graph platform (Neo4j, hybrid retrieval, GNN reranking, RAGAS-evaluated), RAG  |
| 26 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 34025 | Rust | 2026-08-17 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
...
| 28 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | 45665 | Go | 2026-08-17 | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search |
| 29 | [lioensky/VCPToolBox](https://github.com/lioensky/VCPToolBox) | 2255 | JavaScript | 2026-08-17 | VCP 部署在 AI 模型 API 与前端应用之间，是面向AGI OS开发和探索的工业级基建示范项目。通过统一指令协议、多层级持久化记忆、分布式插件引擎及多 Agent 协作框架，将原本“无状态、无记忆、无工具调用能力”的大语言模型，彻底改 |
...
| 31 | [kovartravis/neuron](https://github.com/kovartravis/neuron) | 3 | TypeScript | 2026-08-17 | ⁠Daemonless, local-first semantic memory CLI for AI coding agents using SQLite and Transformers.js. Persistent context f |
...
| 34 | [AdarshSingh-ASR/WorldLine](https://github.com/AdarshSingh-ASR/WorldLine) | 0 | JavaScript | 2026-08-17 | Shared episodic memory and a globally serializable commitment plane for autonomous machines. CockroachDB distributed vec |
| 35 | [topoteretes/cognee](https://github.com/topoteretes/cognee) | 30078 | Python | 2026-08-17 | Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions |
| 36 | [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 6683 | Python | 2026-08-17 |  Memory library for building stateful agents |
| 37 | [NickFlach/kannaka-memory](https://github.com/NickFlach/kannaka-memory) | 2 | Rust | 2026-08-17 |  |
...
| 39 | [AdarshSingh-ASR/Lattice](https://github.com/AdarshSingh-ASR/Lattice) | 0 | JavaScript | 2026-08-17 | Memory that can prove itself, a CockroachDB + AWS control plane for trustworthy incident-response agents. |
| 40 | [schmitech/orbit](https://github.com/schmitech/orbit) | 339 | Python | 2026-08-17 | Self-hosted, OpenAI-compatible AI gateway for private RAG, natural-language data access, and tool-calling agents. |
...
| 43 | [cyberlife-coder/VelesDB](https://github.com/cyberlife-coder/VelesDB) | 87 | Rust | 2026-08-17 | The explainable, local-first memory engine for AI agents. One ~9 MB binary fuses vector + graph + columnar under VelesQL |
| 44 | [taraksh01/memoryhub](https://github.com/taraksh01/memoryhub) | 1 | TypeScript | 2026-08-17 | MCP server for persistent memory using Qdrant vector store |
| 45 | [Rayyan9477/Solace-AI](https://github.com/Rayyan9477/Solace-AI) | 18 | Python | 2026-08-17 | "Solace AI: Your Empathetic Digital Confidant": Solace AI is an empathetic mental health companion that understands your |
| 46 | [vishalChoudhary-git/ai-platform](https://github.com/vishalChoudhary-git/ai-platform) | 0 | Python | 2026-08-17 | Enterprise AI platform with FastAPI, PostgreSQL, Redis and Agentic workflows. |
| 47 | [erishen/rag-task-service](https://github.com/erishen/rag-task-service) | 0 | Rust | 2026-08-17 | Asynchronous task service + RAG document retrieval pipeline in Rust — axum API, SQLite (WAL) with optimistic concurrency |
| 48 | [kalisio/knowledge](https://github.com/kalisio/knowledge) | 2 | Python | 2026-08-17 | AI developer assistant for the Kalisio ecosystem |
| 49 | [Cognipeer/console](https://github.com/Cognipeer/console) | 23 | TypeScript | 2026-08-17 | Open-source, self-hosted AI gateway for multi-tenant orgs: OpenAI-compatible LLM routing, RAG & vector stores, MCP hub,  |
| 50 | [somiljainx2811/RAG_Notes](https://github.com/somiljainx2811/RAG_Notes) | 0 | — | 2026-08-17 | 60 deep-dive markdown notes on Retrieval-Augmented Generation — from embeddings and vector search to agentic RAG, GraphR |
<!-- TRACKER_TABLE_END -->

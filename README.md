...
| 16 | [AgentToolkit/altk-evolve](https://github.com/AgentToolkit/altk-evolve) | 96 | Python | 2026-08-10 | Self improving agents through iterations |
| 17 | [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | 64562 | JavaScript | 2026-08-10 | Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-first agent experience |
| 18 | [4nur4gmishr4/4nur4gmishr4](https://github.com/4nur4gmishr4/4nur4gmishr4) | 1 | JavaScript | 2026-08-10 | Backend-focused fullstack & applied ai dev. Building cool stuff with LLMs & agents. Obsessed with clean architecture & s |
| 19 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 33903 | Rust | 2026-08-10 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
...
| 21 | [Shikhar-code/memcoder](https://github.com/Shikhar-code/memcoder) | 1 | Python | 2026-08-10 | Provider-independent persistent cognition layer for AI agents. |
| 22 | [GiulioDER/RE-call](https://github.com/GiulioDER/RE-call) | 2 | Python | 2026-08-10 | RE-call — Retrieval-Augmented Self-Recall: RAG over an AI agent's own memory that knows when it doesn't know (gap detect |
...
| 24 | [yantrikos/yantrikdb-server](https://github.com/yantrikos/yantrikdb-server) | 171 | Rust | 2026-08-10 | Cognitive memory database for AI agents — consolidates duplicates, detects contradictions, fades stale memories via temp |
...
| 26 | [infino-ai/infino](https://github.com/infino-ai/infino) | 65 | Rust | 2026-08-10 | Fast search engine on object storage, with full text search, vectors, and SQL, natively on Parquet. |
| 27 | [HelixDB/helix-db](https://github.com/HelixDB/helix-db) | 5720 | Rust | 2026-08-10 | HelixDB is an OLTP graph-vector database built in Rust on Object Storage. |
...
| 29 | [matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) | 1875 | Go | 2026-08-10 | AI-native HTAP database with Git-for-Data and built-in vector search, serving as the data and memory backbone for intell |
| 30 | [MariaDB/server](https://github.com/MariaDB/server) | 8069 | C++ | 2026-08-10 | MariaDB server is a community developed fork of MySQL server. Started by core members of the original MySQL team, MariaD |
| 31 | [neuml/txtai](https://github.com/neuml/txtai) | 12836 | Python | 2026-08-10 | 💡 All-in-one AI framework for semantic search, LLM orchestration and language model workflows |
| 32 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | 45590 | Go | 2026-08-10 | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search |
...
| 40 | [kostas221/local-rag-assistant](https://github.com/kostas221/local-rag-assistant) | 0 | Python | 2026-08-10 | Local-first hybrid RAG for scientific PDFs: bilingual (EL/EN) Q&A with page-level citations, an anti-hallucination relev |
| 41 | [Mahee-Jain123/Ai-study-assistant](https://github.com/Mahee-Jain123/Ai-study-assistant) | 0 | Python | 2026-08-10 | AI-powered PDF Question Answering System using RAG, Gemini, LangChain, and ChromaDB. |
| 42 | [PYLA-VENKATA-SAI-KARTHIK/Rag_document_assistant](https://github.com/PYLA-VENKATA-SAI-KARTHIK/Rag_document_assistant) | 1 | Python | 2026-08-10 | AI-powered RAG document assistant for querying PDFs with Streamlit, FAISS, SentenceTransformers, and Groq. |
| 43 | [mahiagarwal830-cpu/AI-College-Chatbot](https://github.com/mahiagarwal830-cpu/AI-College-Chatbot) | 0 | Python | 2026-08-10 | AI-powered College Chatbot using Python, ChromaDB, Groq LLM and Retrieval-Augmented Generation (RAG). |
...
| 45 | [nishan-paul-hello/cmatrix-agentic-red-team](https://github.com/nishan-paul-hello/cmatrix-agentic-red-team) | 0 | Python | 2026-08-10 | 🛡️ CMatrix is an agentic red-team platform for running controlled, human-in-the-loop security simulations across modern  |
| 46 | [nishan-paul-2022/cmatrix-agentic-red-team](https://github.com/nishan-paul-2022/cmatrix-agentic-red-team) | 0 | Python | 2026-08-10 | 🔴 CMatrix-RED is an agentic red-team platform for running controlled, human-in-the-loop security simulations across mode |
| 47 | [thameema/memnos](https://github.com/thameema/memnos) | 7 | Python | 2026-08-10 | Persistent memory for AI coding agents — MCP server, REST API & Python SDK. Works with Claude Code, Cursor, Windsurf and |
| 48 | [lancedb/lancedb](https://github.com/lancedb/lancedb) | 11118 | Rust | 2026-08-10 | Developer-friendly OSS embedded retrieval library for multimodal AI. Search More; Manage Less. |
| 49 | [syalia-srl/beaver](https://github.com/syalia-srl/beaver) | 36 | Python | 2026-08-10 | All-in-one, pure-python, embedded database for relational data, documents, vectors, graphs, and events based on SQlite. |
| 50 | [PushkarKanjani/medical-rag-assistant](https://github.com/PushkarKanjani/medical-rag-assistant) | 0 | Python | 2026-08-10 |  |
<!-- TRACKER_TABLE_END -->

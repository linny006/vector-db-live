...
| 11 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 32449 | Rust | 2026-06-19 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
...
| 13 | [Vansh-7/Vector-DB-RAG-pipeline](https://github.com/Vansh-7/Vector-DB-RAG-pipeline) | 0 | Python | 2026-06-18 | Custom Vector Database and RAG pipeline engineered from scratch in Python. Features NumPy-optimized HNSW, KD-Tree, and B |
| 14 | [kherrera6219/theFactory](https://github.com/kherrera6219/theFactory) | 1 | Python | 2026-06-18 | theFactory is a local-first, event-driven AI software factory for building, modernizing, debugging, securing, porting, v |
| 15 | [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex) | 33197 | Python | 2026-06-18 | 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG |
...
| 17 | [rustic-ai/uni-db](https://github.com/rustic-ai/uni-db) | 38 | Rust | 2026-06-18 | Uni is a modern, embedded database that combines property graph (OpenCypher), vector search, and columnar storage (Lance |
| 18 | [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | 61786 | JavaScript | 2026-06-18 | Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-first agent experience |
| 19 | [StephenCote/AccountManager7](https://github.com/StephenCote/AccountManager7) | 2 | JavaScript | 2026-06-18 | Identity and Authorization Service with Vector and AI Integration |
| 20 | [cyberlife-coder/VelesDB](https://github.com/cyberlife-coder/VelesDB) | 67 | Rust | 2026-06-18 | VelesDB is a local‑first AI data engine written in Rust that unifies vectors, full‑text and graph in a single file with  |
...
| 28 | [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 5271 | Python | 2026-06-18 |  Memory library for building stateful agents |
| 29 | [NickFlach/kannaka-memory](https://github.com/NickFlach/kannaka-memory) | 1 | Rust | 2026-06-18 |  |
| 30 | [yielab/adapta](https://github.com/yielab/adapta) | 0 | Python | 2026-06-18 | Self-hosted platform to specialize and serve private LLMs — Knowledge (RAG) + Fine-tuning (LoRA/QLoRA), including image- |
...
| 38 | [schmitech/orbit](https://github.com/schmitech/orbit) | 282 | Python | 2026-06-18 | A self-hosted AI infrastructure for private RAG and multi-model applications. |
| 39 | [makr-code/ThemisDB](https://github.com/makr-code/ThemisDB) | 7 | C++ | 2026-06-18 | Themis Database System - High-performance C++ hybrid-database (graph-vector-relational-file) with AQL support and MVCC.  |
| 40 | [MoTahaAboHeiba/EduMate-RAG](https://github.com/MoTahaAboHeiba/EduMate-RAG) | 1 | Python | 2026-06-18 | FastAPI RAG microservice powering the AI layer of EduMate, indexes 50+ CS textbooks into ChromaDB for Dev and Qdrant Clo |
| 41 | [blackeagle686/mafqood-ai](https://github.com/blackeagle686/mafqood-ai) | 1 | CSS | 2026-06-18 |       Mafqood is a production-grade AI system designed to help locate missing persons by leveraging state-of-the-art fac |
| 42 | [chrishenyard/Vector.Search](https://github.com/chrishenyard/Vector.Search) | 0 | C# | 2026-06-18 | AI Solution for Indexing Source Code |
| 43 | [rehan243/rehan243](https://github.com/rehan243/rehan243) | 0 | — | 2026-06-18 | Profile README |
...
| 45 | [joicyroslin-svg/Multi-Agent-Research-Assistant](https://github.com/joicyroslin-svg/Multi-Agent-Research-Assistant) | 1 | Python | 2026-06-18 | Advanced Agentic RAG Research Assistant using Gemini API, ChromaDB, vector embeddings, autonomous planner agents, and St |
| 46 | [idaholab/ranger](https://github.com/idaholab/ranger) | 0 | Python | 2026-06-18 | This repository contains a Python-based auto-response bot that uses the GitHub API and LlamaIndex package to monitor and |
| 47 | [cyborginc/cyborgdb-py](https://github.com/cyborginc/cyborgdb-py) | 8 | Python | 2026-06-18 | Python Client SDK for CyborgDB: The Encrypted Vector Database |
| 48 | [hivellm/vectorizer](https://github.com/hivellm/vectorizer) | 24 | Rust | 2026-06-18 | A high-performance, in-memory vector database written in Rust, designed for semantic search and top-k nearest neighbor q |
| 49 | [Denbon001/Smart-RAG-Doc-Buddy](https://github.com/Denbon001/Smart-RAG-Doc-Buddy) | 0 | Python | 2026-06-18 | An intelligent Document Assistant built using FastAPI, Streamlit, and a local Qdrant Vector Database for Retrieval-Augme |
| 50 | [vespa-engine/vespa](https://github.com/vespa-engine/vespa) | 6963 | Java | 2026-06-18 | The AI search platform |
<!-- TRACKER_TABLE_END -->

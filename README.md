...
| 17 | [api-evangelist/nomic-ai](https://github.com/api-evangelist/nomic-ai) | 0 | — | 2026-07-29 | Nomic AI — Nomic Embed + Atlas vector exploration + GPT4All |
| 18 | [api-evangelist/milvus](https://github.com/api-evangelist/milvus) | 0 | — | 2026-07-29 | Open-source cloud-native vector database. |
| 19 | [api-evangelist/marqo](https://github.com/api-evangelist/marqo) | 0 | — | 2026-07-29 | Vector search engine with end-to-end embedding and reranking. |
| 20 | [api-evangelist/lancedb](https://github.com/api-evangelist/lancedb) | 0 | — | 2026-07-29 | LanceDB — open-source serverless multimodal vector database (Lance format) |
| 21 | [api-evangelist/weaviate](https://github.com/api-evangelist/weaviate) | 1 | — | 2026-07-29 | Weaviate is an open-source, AI-native vector database that enables developers to build semantic search and AI-powered ap |
| 22 | [api-evangelist/zilliz](https://github.com/api-evangelist/zilliz) | 0 | — | 2026-07-29 | Vector database service built on Milvus. |
| 23 | [NickFlach/kannaka-memory](https://github.com/NickFlach/kannaka-memory) | 2 | Rust | 2026-07-29 |  |
| 24 | [Shr9vaniii/JanusAI](https://github.com/Shr9vaniii/JanusAI) | 0 | Python | 2026-07-29 | RAG-based onboarding assistant for engineering teams, built on FastAPI's codebase as a case study. Extracts and structur |
| 25 | [NirDiamant/RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques) | 28861 | Jupyter Notebook | 2026-07-29 | This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. Each technique h |
| 26 | [cyberlife-coder/VelesDB](https://github.com/cyberlife-coder/VelesDB) | 78 | Rust | 2026-07-29 | The explainable, local-first memory engine for AI agents. One ~9 MB binary fuses vector + graph + columnar under VelesQL |
| 27 | [elaz48/placeborag](https://github.com/elaz48/placeborag) | 1 | Python | 2026-07-29 | Deterministic test doubles for RAG retrieval. A fake embedder with controllable semantics and a fake vector store that r |
| 28 | [GiulioDER/RE-call](https://github.com/GiulioDER/RE-call) | 2 | Python | 2026-07-29 | RE-call — Retrieval-Augmented Self-Recall: RAG over an AI agent's own memory that knows when it doesn't know (gap detect |
| 29 | [qdrant/qdrant](https://github.com/qdrant/qdrant) | 33643 | Rust | 2026-07-29 | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also av |
| 30 | [opencrawling/opencrawling](https://github.com/opencrawling/opencrawling) | 13 | Java | 2026-07-29 | Reference Java & Spring implementation of the Open Ingestion Standard (OIS). It provides a secure, decoupled, and vendor |
| 31 | [api-evangelist/aerospike](https://github.com/api-evangelist/aerospike) | 0 | — | 2026-07-29 | API and integration profile for Aerospike. |
| 32 | [api-evangelist/mixedbread-ai](https://github.com/api-evangelist/mixedbread-ai) | 1 | — | 2026-07-29 | API Evangelist profile of Mixedbread - embeddings and reranking API |
...
| 34 | [crate/crate](https://github.com/crate/crate) | 4413 | Java | 2026-07-29 | CrateDB is a distributed and scalable SQL database for storing and analyzing massive amounts of data in near real-time,  |
| 35 | [RaisDB/raisdb](https://github.com/RaisDB/raisdb) | 0 | — | 2026-07-29 |  Built on a blazing-fast Rust core, seamlessly unifying relational databases, NoSQL, vector stores, analytics engines, S |
| 36 | [Mostafa23/Enterprise-Agentic-Corrective-RAG](https://github.com/Mostafa23/Enterprise-Agentic-Corrective-RAG) | 0 | Python | 2026-07-29 | An Enterprise-Grade Modular RAG Platform implementing Standard RAG, Corrective RAG (CRAG with Query Rewriting & Evaluati |
...
| 38 | [api-evangelist/vespa-ai](https://github.com/api-evangelist/vespa-ai) | 0 | — | 2026-07-29 | API Evangelist profile of Vespa — AI search engine and vector database |
| 39 | [TheAmitChandra/NeuralCleave](https://github.com/TheAmitChandra/NeuralCleave) | 3 | Python | 2026-07-29 | One AI assistant for every messaging app you use — Telegram, Discord, WhatsApp, Slack & 29 more — with real memory and y |
| 40 | [KonNik88/ml-research-radar](https://github.com/KonNik88/ml-research-radar) | 3 | Python | 2026-07-29 | Custom end-to-end pipeline to find, organize, and reason over ML papers & GitHub repos — with an experimental NVIDIA UDR |
| 41 | [api-evangelist/vespa](https://github.com/api-evangelist/vespa) | 0 | — | 2026-07-29 | Open-source big-data serving engine for search and recommendations. |
| 42 | [infinispan/infinispan](https://github.com/infinispan/infinispan) | 1341 | Java | 2026-07-29 | Infinispan is an open source data grid platform and highly scalable NoSQL cloud data store. |
| 43 | [api-evangelist/surrealdb](https://github.com/api-evangelist/surrealdb) | 0 | — | 2026-07-29 | SurrealDB APIs.json profile for API Evangelist catalog |
| 44 | [oracle/ai-optimizer](https://github.com/oracle/ai-optimizer) | 96 | Python | 2026-07-29 | GenAI/RAG Optimizer and Toolkit for experimentation using Oracle Database AI Vector Search and NL2SQL |
| 45 | [api-evangelist/azure-cosmos-db](https://github.com/api-evangelist/azure-cosmos-db) | 0 | — | 2026-07-29 | API and integration profile for Azure Cosmos DB. |
| 46 | [diegoglozano/revector](https://github.com/diegoglozano/revector) | 3 | Rust | 2026-07-29 | Declarative, versioned schema & config migrations for Qdrant — Alembic for vector collections. |
...
| 50 | [perforate-org/gleaph](https://github.com/perforate-org/gleaph) | 1 | Rust | 2026-07-29 | Decentralized Graph Database with Integrated Vector Search |
<!-- TRACKER_TABLE_END -->
